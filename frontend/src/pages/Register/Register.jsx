    ...
    <div className="reg-page-wrapper">
      <div className="reg-side-banner">
        <div className="banner-text">
          ...
          <p>
            Chúng tôi cung cấp các giải pháp vận chuyển và quản lý chuỗi cung
            ứng hiện đại, giúp doanh nghiệp tối ưu chi phí, thời gian và hiệu
            quả vận hành.
          </p>
          ...
          <div className="banner-features">
            ...
            <div className="feature-item">
              ✓ Hỗ trợ khách hàng và tư vấn 24/7
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="reg-card">
          ...
          <form onSubmit={handleSignup} className="reg-form">
            ...
            <div className="reg-terms">
              Bằng cách đăng ký, bạn đồng ý với <span>Điều khoản dịch vụ</span>{" "}
              của chúng tôi.
            </div>
